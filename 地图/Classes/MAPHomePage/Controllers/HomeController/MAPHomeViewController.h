...
@interface MAPHomeViewController : UIViewController <BMKMapViewDelegate, BMKLocationServiceDelegate, MAPHomeViewDelegate, MAPAnnotationViewDelegate, MAPCommentViewDelegate, BMKGeoCodeSearchDelegate>
